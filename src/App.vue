...
import MagneticDrawerService from './services/magnetic-drawer/MagneticDrawerService';
import { fabric } from 'fabric';

const coreThickness = ref(10);
let magneticDrawer: MagneticDrawerService;
//const draw = () => {
...
onMounted(() => {
  ...
  magneticDrawer = new MagneticDrawerService(canvas);
